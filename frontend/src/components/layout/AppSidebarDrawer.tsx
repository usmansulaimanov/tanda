...
export const AppSidebarDrawer: React.FC = () => {
  ...
  return (
    <div className="sidebar-drawer-overlay" onClick={closeSidebar}>
      ...
      >
        {/* Drawer Header */}
        <div className="sidebar-drawer-header" style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <Link
            to={homeRoute}
        ...
        <div className="sidebar-drawer-body">
          ...
          {isAuthor ? (
            <div className="sidebar-nav-group">
              ...
              <Link
                to="/author/stats"
                className={`sidebar-nav-link ${location.pathname === '/author/stats' ? 'active' : ''}`}
                onClick={closeSidebar}
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="sidebar-nav-group">
              ...
              <Link
                ...
                className={`sidebar-nav-link ${location.pathname.startsWith('/admin/certificates') ? 'active' : ''}`}
                onClick={closeSidebar}
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
