          ...
          <div className="max-w-7xl mx-auto px-3 py-2 sm:px-6 sm:py-2.5">
            <div className="flex flex-col md:flex-row items-center justify-between gap-2 sm:gap-3">
              ...
              <div
                ...
                className="flex items-center gap-2.5 sm:gap-3 w-full md:w-1/4 min-w-0 cursor-pointer group"
                title="Толық ойнатқышты ашу үшін басыңыз"
              >
                <div
                  className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center text-white shrink-0 shadow-sm overflow-hidden relative group-hover:scale-105 transition-transform"
                  style={{
                ...
                <button
                  ...
                  className="md:hidden w-7 h-7 rounded-lg bg-slate-100 text-slate-400 hover:text-slate-800 flex items-center justify-center shrink-0 ml-auto"
                >
              ...
              <div className="flex flex-col items-center w-full md:w-2/4 max-w-lg gap-1 sm:gap-1.5">
                {/* Controls row */}
                <div className="flex items-center justify-center gap-1 sm:gap-2 w-full">
                  ...
                  <button
                    ...
                    className={`relative p-1.5 sm:p-2 rounded-xl border text-xs font-bold transition-all cursor-pointer flex items-center justify-center ${
                      repeatMode !== 'off'
                  ...
                  <button
                    type="button"
                    onClick={prevChapter}
                    className="p-1.5 sm:p-2 rounded-xl bg-[#F8FAFC] border border-slate-200 text-slate-700 hover:bg-[#E8F1FB] hover:text-[#005494] hover:border-[#005494]/30 transition-all cursor-pointer flex items-center justify-center shadow-sm"
                    style={{ width: '32px', height: '32px' }}
                  ...
                  <button
                    type="button"
                    onClick={togglePlay}
                    className="w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-[#005494] hover:bg-[#003F70] text-white flex items-center justify-center shadow-lg transition-transform active:scale-95 cursor-pointer shrink-0 border-2 border-white mx-0.5"
                  ...
                  >
                    <span className="text-[10px] sm:text-[11px] font-bold">+10с</span>
                    <RotateCw className="w-3 sm:w-3.5 h-3 sm:h-3.5 text-[#005494]" />
                  </button>
                  ...
                  <div className="relative" ref={timerMenuRef}>
                    <button
                      ...
                      className={`h-8 sm:h-9 px-2 sm:px-2.5 rounded-xl border text-xs font-bold transition-all cursor-pointer flex items-center gap-1 shadow-sm ${
                        sleepTimerMinutes
                  ...
                  <div className="relative" ref={speedMenuRef}>
                    <button
                      ...
                      className={`h-8 sm:h-9 px-1.5 sm:px-2 rounded-xl border text-[11px] sm:text-xs font-bold transition-all cursor-pointer flex items-center justify-center min-w-[30px] sm:min-w-[36px] shadow-sm ${
                        playbackRate !== 1
              ...
              {/* Right: Chapter list / Close Action (desktop) */}
              <div className="hidden md:flex items-center justify-end w-full md:w-1/4 gap-2">
                {chapters.length > 1 && (
