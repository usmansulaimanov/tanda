        ...
        <div className="fixed bottom-0 inset-x-0 z-50 bg-white/95 backdrop-blur-md border-t border-slate-200 shadow-2xl transition-all">
          <div className="max-w-7xl mx-auto px-4 py-2.5 sm:px-6">
            <div className="flex flex-col md:flex-row items-center justify-between gap-3">
              ...
              >
                <div
                  className="w-12 h-12 rounded-xl flex items-center justify-center text-white shrink-0 shadow-sm overflow-hidden relative group-hover:scale-105 transition-transform"
                  style={{
                ...
                <div className="min-w-0 flex-1">
                  <h4 className="text-sm font-bold text-slate-900 truncate group-hover:text-[#005494] transition-colors flex items-center gap-1.5">
