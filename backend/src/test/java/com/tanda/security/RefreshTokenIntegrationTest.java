...
public class RefreshTokenIntegrationTest {
    ...
    void setUp() {
        ...
        testUser = User.builder()
                .id("test-refresh-user-" + UUID.randomUUID().toString().substring(0, 8))
                .idNumber("999001")
    ...
    void refresh_tokenRotation_worksAndInvalidatesPreviousToken() throws Exception {
        ...
        // Step 2: Refresh with cookie1 -> should succeed and issue cookie2
        ...
        // Step 3: Reuse detection: replay cookie1 -> should fail with 401 and revoke all sessions
        mockMvc.perform(post("/api/v1/auth/refresh")
                        .cookie(refreshCookie1))
                .andExpect(status().isUnauthorized());

        // Step 4: Even cookie2 should now be revoked due to reuse detection
        mockMvc.perform(post("/api/v1/auth/refresh")
